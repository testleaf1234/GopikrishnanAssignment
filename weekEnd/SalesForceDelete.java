...
public class SalesForceDelete {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		WebElement OpportunityFound = driver.findElement(By.xpath("//a[text()='Salesforce Automation by Gopikrishnan.G']"));
        String text = OpportunityFound.getText();
		if(text.equals("Salesforce Automation by Gopikrishnan.G")) {
